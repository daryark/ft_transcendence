...
describe('Room Manager', () => {
    ...
    test('#5 returns room state', () => {
        ...
        expect(state.players).toEqual(['s1']);
    ...
    //     const result = roomManager.addPlayer('room1', 'socket3', 'player', '1v1');
    ...
    //     const result = roomManager.addPlayer('room1', 'socket3', 'spectator', '1v1');
