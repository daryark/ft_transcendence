...
Main plan:
• Web: Use frameworks (frontend + backend = 2pts) + ORM (1pt) + advanced search and filters/sorting (1pt) = 4 points
• Accessibility and Internationalization: 3 browsers supoport (1pt) = 1 point
• Gaming and user experience: Web-based game (2pts) + Remote players (2pts) + Multiplayer (2pts) + Game customization (1pt) + Gamification system/achievements (1pt) + Spectator mode (1pt)  = 9 points
...
• Major: Allow users to interact with other users. The minimum requirements are: + Masha(Front), Sasha (Back)
...
IV.2 Accessibility and Internationalization (We're doing only if we have a time and need it!) ?
...
IV.3 User Management Sasha(back), Masha (Front) +
...
• Major: Implement a complete web-based game where users can play against each + Masha (Front and logics), Dasha (Back server)
other.
...
IV.7 Devops
• Major: Infrastructure for log management using ELK (Elasticsearch, Logstash,  + Sasha
Kibana).
